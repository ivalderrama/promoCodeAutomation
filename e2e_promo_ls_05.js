//Testing by creating a promo code, setting date in the past, edit and set it set to Live, then trying to apply the promo code to a deal.
var config = require('./e2e_promo_config.js');

describe("Liv-05. Expired promocode, then apply promocode", function() {
    ...
    it("Save promocode", function (){
        ...
        element(by.id("valid-from")).sendKeys("01/01/2017");
        element(by.id("valid-to")).sendKeys("16/01/2017");
    ...
    it("Login to Living-social purchase an item and apply code", function() {
        ...
        element(by.id("invalid-promo-code")).getText().then(function (text) {
            ...
            console.log(text);
            expect(text).toContain("Code "+ promoCode2string +" has expired.");
