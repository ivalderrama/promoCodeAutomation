...
/* User being used is wowcher.test02@hotmail.com. Run the following code in database to find out count:

 select * from customer where id=1133483748;
...
describe("Liv-17. Promocode is dependent on user total purchase count, where user applying promocode does NOT meet criteria", function() {
    ...
    it("Save promocode", function (){
        ...
        element(by.id("total_purchase_count_gt")).sendKeys("0");
        element(by.id("total_purchase_count_lt")).sendKeys("1");
