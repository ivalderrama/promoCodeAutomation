...
//Selecting the Social Tag as Accessories and trying to purchase an item deal with AfterDark tag"
var config = require('./e2e_promo_config.js');

describe("Liv-11. Selecting the social tag as 'Accessories', then apply promocode to deal with 'AfterDark' tag", function() {
    ...
    it("Save promocode", function (){
        ...
        // Selecting sub-category: Accessories
        element(by.id("149-accessories")).click();
