...
describe("Liv-19. Promocode is dependent on user total purchase value, where user applying promocode does NOT meet criteria", function() {
    ...
    it("Save promocode", function (){
        ...
        element(by.id("total_purchase_value_gt")).sendKeys("0");
        element(by.id("total_purchase_value_lt")).sendKeys("5");
