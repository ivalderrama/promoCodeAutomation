...
describe("Liv-23. Promocode is dependent on user subscription date, where user applying promocode does NOT meet criteria", function() {
    ...
    it("Save promocode", function (){
        ...
        //Subscription date
        element(by.id("signup_start_date")).sendKeys("10/03/2017");
        element(by.id("signup_end_date")).sendKeys("12/03/2017");
