...
/* User being used is wowcher.test02@hotmail.com. Run the following code in database to find out purchase value:
 ...
 select max(order_date) from product_order po
...
describe("Liv-21. Promocode is dependent on user last purchase date, where user applying promocode does NOT meet criteria", function() {
    ...
    it("Save promocode", function (){
        ...
        //Last purchase date
        element(by.id("last_purchase_start_date")).sendKeys("10/03/2017");
        element(by.id("last_purchase_end_date")).sendKeys("12/03/2017");
