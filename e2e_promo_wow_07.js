...
//Testing the platform 'iOS' and trying to access from desktop browser.
var config = require('./e2e_promo_config.js');

describe("Wow-07. Setting platform checkbox to 'iOS', then apply promocode to deal only for desktop browser", function() {
    ...
    it("Save promocode", function (){
        ...
        //Platforms - checking the iOS checkbox
        element(by.id("ext-gen354")).click();
