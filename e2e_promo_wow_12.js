...
describe("Wow-12. Selecting location as 'London', sub cat as 'Adult and tags as 'AfterDark' then applying promocode only for deal that is configured for it", function() {
