...
//Selecting the Sub Category as Activities and trying to purchase an item deal within Adult category
var config = require('./e2e_promo_config.js');

describe("Liv-10. Selecting the sub category as 'Activities', then apply promocode to deal within 'Adult' category", function() {
    ...
    it("Save promocode", function (){
        ...
        // Selecting sub-category: Activities
        element(by.id("ext-gen553")).click();
