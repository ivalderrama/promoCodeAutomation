...
describe("Wow-02. Create promocode and leave RAW, then apply promocode", function() {
...
/*
    it("Edit promocode and leave it set to Raw", function () {

        browser.ignoreSynchronization=true;

        browser.get("https://wps04.devwowcher.co.uk/");

        element(By.id("iun")).sendKeys("ivantest@wowcher.co.uk");
        element(by.id("passwd")).sendKeys("Password123");
        element(by.buttonText("Login")).click();
        browser.sleep(2000);
        element(by.id("ext-gen87")).click();
        element(by.id("ext-comp-1008")).sendKeys("Wowcher");
        ...
        //browser.sleep (1000);
        //element(by.xpath('//*[@id="status-combo"]')).clear().sendKeys('Live');
