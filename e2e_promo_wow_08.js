...
//Testing the platform 'desktop' checkbox and trying to access from desktop browser
var config = require('./e2e_promo_config.js');

describe("Wow-08. Setting platform checkbox 'desktop', then apply promocode to deal only for desktop browser", function() {
