...
describe("Liv-13. Deal is wallet applicable, user has marketing credit only", function() {
    ...
    it("Login to Living-social, check marketing credit box, then apply promocode", function() {
        ...
        element(by.xpath(".//*[@id='content-fixed']/div/ui-view/div/div/div/div[1]/div/div/div/div[5]/div/div[2]/cmp-promo-code/div/p")).getText().then(function (text) {
    ...
    it("Login to Living-social, apply promocode, then check marketing credit box", function() {
